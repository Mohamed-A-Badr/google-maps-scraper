...
class SearchTracker:
    def __init__(self, country: str, governorate: str):
        """
...
def get_search_tracker(country: str, governorate: str) -> "SearchTracker":
    """Get or create a global search tracker for the country."""
    global global_search_tracker
    if (
        global_search_tracker is None
        or global_search_tracker.country != country.lower().replace(" ", "_")
        or global_search_tracker.governorate != governorate
    ):
        global_search_tracker = SearchTracker(country, governorate)
