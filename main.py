...
class Scraper:
    ...
    def loading_search_results(self, search_query, lat, long):
        """
        ...
        Args:
            ...
            long (float): longitude for the search location
        """
        encoded_query = quote_plus(search_query)
        url = f"https://www.google.com/maps/search/{encoded_query}/@{lat},{long},16z"
